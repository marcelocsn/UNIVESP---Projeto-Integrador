...
function Update(){
    ...
    const [dadosAluno, setDadosAluno] = useState([{dataDeNascimento: '', dataDeAdmissão:'',dataDeCasamento:'',dataDeNascimentoDoCônjuge:'',dataPrimeiraDose:'', dataSegundaDose:'', dataTerceiraDose:''}]);
    ...
    return (
      ...
      initialValues={{
          idalunos: dadosAluno[0].idalunos,
          pelotao: dadosAluno[0].pelotao,
          numeroAluno: dadosAluno[0].numeroAluno,
          re: dadosAluno[0].re,
          nomeCompleto: dadosAluno[0].nomeCompleto,
          nomeDeGuerra: dadosAluno[0].nomeDeGuerra,
          dataDeAdmissão: dadosAluno[0].dataDeAdmissão.split("T")[0],
          dataDeNascimento: dadosAluno[0].dataDeNascimento.split("T")[0],
          remanescente: dadosAluno[0].remanescente,
          rg: dadosAluno[0].rg,
          cpf: dadosAluno[0].cpf,
          sexo:  dadosAluno[0].sexo,
          telefoneCelular: dadosAluno[0].telefoneCelular,
          telefoneContato: dadosAluno[0].telefoneContato,
          natural: dadosAluno[0].natural,
          ufNascimento: dadosAluno[0].ufNascimento,
          cursoSuperiorQual: dadosAluno[0].cursoSuperiorQual,
          estadoCivil: dadosAluno[0].estadoCivil,
          possuiFilhosQuantos:  dadosAluno[0].possuiFilhosQuantos,
          dataDeCasamento: dadosAluno[0].dataDeCasamento.split("T")[0],
          nomeDoCônjuge: dadosAluno[0].nomeDoCônjuge,
          dataDeNascimentoDoCônjuge: dadosAluno[0].dataDeNascimentoDoCônjuge.split("T")[0],
          profissãoDoCônjuge: dadosAluno[0].profissãoDoCônjuge,
          suasRedesSociais: dadosAluno[0].suasRedesSociais,
          nomeDoPai: dadosAluno[0].nomeDoPai,
          profissãoDoPai: dadosAluno[0].profissãoDoPai,
          nomeDaMãe: dadosAluno[0].nomeDaMãe,
          profissãoDaMãe: dadosAluno[0].profissãoDaMãe,
          sinaisParticulares: dadosAluno[0].sinaisParticulares,
          suaAltura: dadosAluno[0].suaAltura,
          cútis: dadosAluno[0].cútis,
          corDosOlhos: dadosAluno[0].corDosOlhos,
          corDosCabelos: dadosAluno[0].corDosCabelos,
          tipoDeCabelo: dadosAluno[0].tipoDeCabelo,
          idiomasQueFala: dadosAluno[0].idiomasQueFala,
          tipoSanguineo: dadosAluno[0].tipoSanguineo,
          fatorRh: dadosAluno[0].fatorRh,
          citeUmBancoEmQuePossuiConta: dadosAluno[0].citeUmBancoEmQuePossuiConta,
          tipoDeConta: dadosAluno[0].tipoDeConta,
          agência: dadosAluno[0].agência,
          númeroDaConta: dadosAluno[0].númeroDaConta,
          númeroDaCarteiraProfissional: dadosAluno[0].númeroDaCarteiraProfissional,
          númeroDeSérieDaCarteiraProfissional: dadosAluno[0].númeroDeSérieDaCarteiraProfissional,
          númeroPisPasep: dadosAluno[0].númeroPisPasep,
          númeroTítuloDeEleitor: dadosAluno[0].númeroTítuloDeEleitor,
          númeroZonaVotação: dadosAluno[0].númeroZonaVotação,
          númeroDaSeção: dadosAluno[0].númeroDaSeção,
          cidadeEmQueVota: dadosAluno[0].cidadeEmQueVota,
          númeroRegistroCnh: dadosAluno[0].númeroRegistroCnh,
          vencimentoDaCnh: dadosAluno[0].vencimentoDaCnh,
          categoriaDaCnh: dadosAluno[0].categoriaDaCnh,
          endereçoEmRibeirãoPreto: dadosAluno[0].endereçoEmRibeirãoPreto,
          bairro: dadosAluno[0].bairro,
          cep: dadosAluno[0].cep,
          pontoDeReferência: dadosAluno[0].pontoDeReferência,
          dpRibeirãoPreto: dadosAluno[0].dpRibeirãoPreto,
          batalhãoCidadeDeResidência: dadosAluno[0].batalhãoCidadeDeResidência,
          ciaRibeirãoPreto: dadosAluno[0].ciaRibeirãoPreto,
          emailPessoal: dadosAluno[0].emailPessoal,
          emailFuncional: dadosAluno[0].emailFuncional,
          seMorarComOutrosPmsInformarNomeEPelotãoDoPm: dadosAluno[0].seMorarComOutrosPmsInformarNomeEPelotãoDoPm,
          possuiResidênciaPrópria: dadosAluno[0].possuiResidênciaPrópria,
          possuiCarro: dadosAluno[0].possuiCarro,
          placaCarro: dadosAluno[0].placaCarro,
          modeloCarro: dadosAluno[0].modeloCarro,
          anoCarro: dadosAluno[0].anoCarro,
          possuiMoto: dadosAluno[0].possuiMoto,
          placaMoto: dadosAluno[0].placaMoto,
          modeloMoto: dadosAluno[0].modeloMoto,
          anoMoto: dadosAluno[0].anoMoto,
          jaFoiConduzidoAoDp:  dadosAluno[0].jaFoiConduzidoAoDp,
          seSimInformeOMotivo: dadosAluno[0].seSimInformeOMotivo,
          jaRespondeuOuRespondeInquéritoPolicial: dadosAluno[0].jaRespondeuOuRespondeInquéritoPolicial,
          JáTeveOuPossuiAlgumaDoençaGrave: dadosAluno[0].JáTeveOuPossuiAlgumaDoençaGrave,
          oQueVocêAlmejaNaPM: dadosAluno[0].oQueVocêAlmejaNaPM,
          possuiAlergiaAAlgumAlimentoOuMedicação: dadosAluno[0].possuiAlergiaAAlgumAlimentoOuMedicação,
          possuiPlanoDeSaúde: dadosAluno[0].possuiPlanoDeSaúde,
          quantasVezesJáPrestouParaAPm: dadosAluno[0].quantasVezesJáPrestouParaAPm,
          reprovadoEmQueFase: dadosAluno[0].reprovadoEmQueFase,
          possuiParentesPM: dadosAluno[0].possuiParentesPM,
          seSimInformeONomeDoParentePM: dadosAluno[0].seSimInformeONomeDoParentePM,
          tomouVacinaDaCovid: dadosAluno[0].tomouVacinaDaCovid,
          dataPrimeiraDose: dadosAluno[0].dataPrimeiraDose.split("T")[0],
          laboratorioPrimeiraDose: dadosAluno[0].laboratorioPrimeiraDose,
          dataSegundaDose: dadosAluno[0].dataSegundaDose.split("T")[0],
          laboratorioSegundaDose: dadosAluno[0].laboratorioSegundaDose,
          dataTerceiraDose: dadosAluno[0].dataTerceiraDose.split("T")[0],
          laboratorioTerceiraDose: dadosAluno[0].laboratorioTerceiraDose,
          religiao: dadosAluno[0].religiao,
          nivelInstrucao: dadosAluno[0].nivelInstrucao,
